...
import { BrowerClient, BrowserPlugin, ResourceErrorMonitorConfig, ResourceErrorPayload } from '@monitorjstypes';
 ...
 */
export class ResourceErrorMonitorPlugin implements BrowserPlugin {
