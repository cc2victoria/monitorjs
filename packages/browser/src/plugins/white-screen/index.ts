...
import { BrowerClientInterface, BrowserPluginInterface, WhiteScreenMonitorConfig } from '@monitorjstypes'
import {
 ...
 * 监控白屏
 */
export class WhiteScreenMonitorPlugin implements BrowserPluginInterface {
  ...
  public setupOnce = (client: BrowerClientInterface) => {
    try {
